...
SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwVUFmjJP-N-w8XOyQI6Kc_nKzbjWwNXZddgZChPiyRzIDliL0-hvP9zAoy4SrIXf8/exec"
...
if nim:
    ...
    if not student_courses.empty:
        ...
        for _, row in student_courses.iterrows():
            ...
            # If any "-" still exists, mark as not filled
            if "-" in (q1, q2, q3, q4, q5, q6):
                all_filled = False
