...
if nim:
    ...
    if not student_courses.empty:
        ...
        for _, row in student_courses.iterrows():
            ...
            q1 = st.selectbox("1. Dosen menguasai materi pembelajaran dengan baik dan mudah dipahami, menggunakan sumber-sumber referensi terbaru serta mengembangkan gagasan baru/inovatif",options=[1, 2, 3, 4, 5],index=-1,key=f"{course}_q1")
